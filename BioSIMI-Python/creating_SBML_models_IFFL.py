...
r3 = NewReaction(model.createReaction())
...
r4 = NewReaction(model.createReaction())
...
r5 = NewReaction(model.createReaction())
...
r6 = NewReaction(model.createReaction())
...
r7 = NewReaction(model.createReaction())
...
r8 = NewReaction(model.createReaction())
...
r9 = NewReaction(model.createReaction())
...
r10 = NewReaction(model.createReaction())
...
r11 = NewReaction(model.createReaction())
...
r12 = NewReaction(model.createReaction())
...
r13 = NewReaction(model.createReaction())
...
r14 = NewReaction(model.createReaction())
...
r15 = NewReaction(model.createReaction())
...
r16 = NewReaction(model.createReaction())
...
r17 = NewReaction(model.createReaction())
...
r18 = NewReaction(model.createReaction())
